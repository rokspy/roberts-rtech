...
while (z == 1){
  ...
  std::cout << "Enter 1 to stay in this example or 0 to continue: ";
  std::cin >> z;
	std::cout << std::endl;
	if(z == 0) break;

  std::cout << "Input orientation w: ";
  std::cin >> target_pose1.orientation.w;
  std::cout << std::endl;
//		target_pose1.orientation.w = 1;

  std::cout << "Input orientation x: ";
  std::cin >> target_pose1.orientation.x;
  std::cout << std::endl;
//	target_pose1.orientation.x = 0;
	
  std::cout << "Input orientation y: ";
  std::cin >> target_pose1.orientation.y;
  std::cout << std::endl;
//	target_pose1.orientation.y = 0;

  std::cout << "Input orientation z: ";
  std::cin >> target_pose1.orientation.z;
  std::cout << std::endl;
//	target_pose1.orientation.z = 0;

  std::cout << "Input target pose x: ";
  std::cin >> target_pose1.position.x;
  std::cout << std::endl;
//	target_pose1.position.x = 0.1;
  
  std::cout << "Input target pose y: ";
  std::cin >> target_pose1.position.y;
  std::cout << std::endl;
//	target_pose1.position.y = 0.2;

  std::cout << "Input target pose z: ";
